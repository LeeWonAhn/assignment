...
//Question 1
console.log("Ques 1");
var s1: String = new String("Tiên học lễ, Hậu học văn");
console.log("So luong ky tu: " + s1.length);
//Question 2
console.log("Ques 2");
var s2: String = new String("cách tốt nhất để làm mọi thứ là ngừng nói và làm ngay bây giờ")
var splitedWord = s2.split(" "); // tách các từ trong chuỗi
var capitalizedWords = splitedWord.map(word => word.charAt(0).toUpperCase() + word.slice(1)); // viết hoa chữ cái đầu của mỗi từ
var capitalizedStr = capitalizedWords.join(" "); // ghép các từ lại thành chuỗi mới
console.log(capitalizedStr);
//Question 3
console.log("Ques 3");
var s3: String = new String("Họ* đi đôi *ới hàn*")
